  ...
  const naviItems = [
    {
      ...
      dropdown: true,
      routes: [
        { routeName: "travel story", linkName: "travelStory" },
        { routeName: "travel guides", linkName: "travelGuides" },
      ],
    },
    {
      id: 2,
      ...
      dropdown: true,
      routes: [
        { routeName: "post a story", linkName: "postastory" },
        { routeName: "add a review", linkName: "addareview" },
      ],
    },
    {
      id: 3,
      ...
      dropdown: true,
      routes: [
        { routeName: "flights", linkName: "flights" },
        { routeName: "Rental Cars", linkName: "rentalcars" },
      ],
    },
              ...
              >
                {navItem.dropdown ? (
                  <div className="dropdown dropdown-hover ">
                    <div>
                      <label
                        className="w-full group flex items-center gap-2 font-medium uppercase px-6 py-3"
                        tabIndex={0}
                      >
                        {navItem.name}{" "}
                        <BsChevronDown className="group-hover:rotate-180 duration-300"></BsChevronDown>
                    ...
                    <ul
                      tabIndex={0}
                      className="dropdown-content z-[10] ml-3 menu shadow-lg bg-base-200 rounded-box  w-52"
                    >
                      {navItem.routes.map((route, index) => (
                        <NavLink
                          className={({ isActive }) =>
