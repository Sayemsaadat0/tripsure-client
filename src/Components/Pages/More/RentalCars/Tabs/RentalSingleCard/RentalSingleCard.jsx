            ...
            <div className="lg:flex gap-3 space-y-2 md:space-y-0">
              ...
              <div className="py-3  rounded-md p-2">
                <div className="flex gap-2 justify-between items-end">
                  <div>
                    <h2 className="text-cyan-500 flex gap-2 items-center text-md text-lg">Features:</h2>
                    {
                    ...
                    <p className="text-md text-cyan-500">Daily Rate: <span className='font-semibold'>{cardItem?.daily_rate}</span></p>
                  </div>
                  <div className="flex justify-end ">
                    <button className="bg-cyan-400 ms-auto hover:bg-cyan-600 hover:translate-x-2 font-bold hover:translate-y-2 transition-all  px-4 py-2 rounded-full text-white">
                      Book Now
                    </button>
                  </div>
                </div>
