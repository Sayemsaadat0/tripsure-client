    ...
    >
      <div className="flex bg-black bg-opacity-60 p-4  items-center justify-center flex-col h-full min-h-[calc(100vh-0px)]">
        <div className="max-w-lg w-full mx-auto mt-4 border-2 border-[#2d969e] p-4 md:p-8 lg:p-12 text-gray-300 bg-white bg-opacity-80 rounded-lg hover:shadow-lg">
          <h2 className="text-2xl text-[#2d969e] text-center font-bold mb-4">
            Please Login
          </h2>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              ...
              />
              <span
                className=" w-fit mr-0 cursor-pointer text-[#2d969e]"
            ...
            <div className="flex justify-between items-center gap-3 md:gap-0 ">
              <p className=" w-fit text-[#2d969e]">
                New this site? Please{" "}
                <Link
                  className="my-link text-[#2d969e] font-bold relative"
                  to={"/register"}
                >
                  Register
                </Link>
              ...
              <span
                ...
                className="my-link cursor-pointer relative text-[#2d969e] font-bold "
              >
                Forget Password
              </span>
            </div>
