        ...
        <div className="absolute p-5 top-0">
          ...
          <div className="mt-96 text-white  w-[420px] gap-4 ">
            <h2 className="text-4xl font-bold mb-4">
              Create Your Account, Enter, and Discover a World of New
              Experiences.
            </h2>

            <p className="text-lg">
              Travel isn't just about reaching destinations; it's about
              discovering yourself along the way and finding the extraordinary
              in the ordinary.
            </p>
            <p>- Unknown</p>
          </div>
        ...
        <div className=" lg:p-20">
          <h2 className="text-center text-3xl md:text-4xl lg:text-5xl mb-10 ">
            <span className="text-2xl lg:text-3xl tracking-widest">
              Join and Explore Fresh Horizons
            </span>{" "}
            <br /> <span className="font-bold">Sign Up Now</span>{" "}
          </h2>
          <div>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className=" w-fit ">
                ...
                <Link className="my-link  font-bold relative" to={"/login"}>
                  Login
                </Link>
              </p>
