    ...
    <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
          <div className='space-y-6'>
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='hotel_website' className='block text-gray-600 mb-2'>
                Hotel Website
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='hotline_number' className='block text-gray-600 mb-2'>
              hotline Number
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='roomFeatures' className='block text-gray-600 mb-2'>
              Room Features
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
