...
<div>
    <h2 className='text-center font-bold text-xl mb-20'>Add Resturants </h2>
</div>
    ...
    <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
          <div className='space-y-6'>
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='cuisine' className='block text-gray-600 mb-2'>
                cuisine
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='menu' className='block text-gray-600 mb-2'>
                menu
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='hours' className='block text-gray-600 mb-2'>
              Hours
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
          ...
          <div className='space-y-6'>
            <div className='space-y-1 text-sm'>
              <label htmlFor='speciality' className='block text-gray-600 mb-2'>
              speciality
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
            ...
            <div className='space-y-1 text-sm'>
              <label htmlFor='features' className='block text-gray-600 mb-2'>
               Features
              </label>
              <input
                className='w-full px-4 py-3 text-gray-800 border border-cyan-300  focus:outline-cyan-500 rounded-md '
