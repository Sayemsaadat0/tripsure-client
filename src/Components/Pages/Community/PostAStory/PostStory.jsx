    ...
    const onSubmit = data => {
        ...
        imageUpload(data.image[0])
            .then(data => {
                ...
                const story = {
                    description, country, postedBy, photoURL
                    , title, withYou, whenYouGo, url, imgUrlTitleDescription,
                }
    ...
    return (
        <div className='pt-16 story bg-no-repeat border'>
            <Container>
                ...
                <h2 className='font-semibold text-2xl underline  tracking-widest text-center pt-10 '>Wanderlust Chronicles: A Traveler's Diary </h2>
                    ...
                    <div className='p-10 backdrop-blur-md '>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className=' mb-3 flex flex-col justify-center items-center gap-2'>
                                ...
                                <textarea placeholder='What were some things you enjoyed about this experience? How can it be improved?' className='rounded-xl  w-full border-2 border-gray-400 py-1 px-2 md:w-96 '  {...register("description")} cols="30" rows="5"></textarea>
                            </div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                {
                                    imgUrlTitleDescription.length > 0 && <div className='border-2 px-2 divide-y-2 md:w-96'>
                                        {
