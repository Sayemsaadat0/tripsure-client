    ...
    >
        {
             allHotels?.map((todo,index)=>(
              ...
              <SwiperSlide key={index}>
                <Link to={''}>
                <img className='h-64 w-full  object-cover' src={todo.picture} alt="" />
                <h2 className='text-black font-bold text-xl'>{todo.cardtitle}</h2>
            ...
            <h3 className='text-md font-bold'>From ${todo.costperperson}/night</h3>
                </Link>
              </SwiperSlide>
